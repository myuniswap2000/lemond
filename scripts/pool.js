...
async function main() {
  ...
  await this.oktPool.notifyRewardAmount(hre.ethers.utils.parseEther("1000000"))
  console.log('notifyRewardAmount')
  await this.LEMD.mint(this.oktPool.address,hre.ethers.utils.parseEther("1000000"))
}
